...
class ImageMaskDataset(Dataset):
    def __init__(self, image_dir,mask_dir,mask_file_tag="",image_only_transforms=None,image_mask_transforms=[]):
        self.image_dir = image_dir
        self.mask_dir = mask_dir
        self.image_names = [file for file in os.listdir(image_dir) if os.path.splitext(file)[1] == ".JPG"]
    ...
    def __getitem__(self, idx):
        ...
        mask_path = os.path.join(self.mask_dir, f"{self.image_names[idx][:-4]}{self.mask_file_tag}.gif")
